...
class NomChoserAll extends JPanel {
	/**
	 * 
	 */
	private static final long serialVersionUID = -6770803378382186104L;
	// private AdminPravTableModel adminPravModel;
	// private JTable jTableListPrav;
	final JTable jTableList;

	public NomChoserAll(JTable jTableListS,
			...
			//			.toString();
				...
				if ((isFolderValue) && (arg0.getClickCount() == 2)
					...
					if ((((ImageIcon) jTableList.getValueAt(rowIndex, 0))
						...
						nomModelSelect
								.setDataGr((orm.Nomenclature) jTableList
